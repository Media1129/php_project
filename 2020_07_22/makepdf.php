...
//second row
$pdf->Rect(72, 49, 3.8, 3.8, 3.5, 'DF'); //專科以上學校
...
//third row
$pdf->Rect(72, 55.6, 3.8, 3.8, 3.5, 'DF'); //教師
$pdf->Rect(94, 55.6, 3.8, 3.8, 3.5, 'DF'); //研究人員
$pdf->Rect(125, 55.6, 3.8, 3.8, 3.5, 'DF'); //專業人員
$pdf->Rect(155.8, 55.6, 3.8, 3.8, 3.5, 'DF'); //其他
//fourth row
$pdf->Rect(72, 62.3, 3.8, 3.8, 3.5, 'DF'); //教師
$pdf->Rect(94, 62.3, 3.8, 3.8, 3.5, 'DF'); //研究人員
$pdf->Rect(114.5, 62.3, 3.8, 3.8, 3.5, 'DF'); //專業人員
$pdf->Rect(130, 62.3, 3.8, 3.8, 3.5, 'DF'); //其他
$pdf->Rect(156, 62.3, 3.8, 3.8, 3.5, 'DF'); //教師
$pdf->Rect(183, 62.3, 3.8, 3.8, 3.5, 'DF'); //研究人員
$pdf->Rect(209, 62.3, 3.8, 3.8, 3.5, 'DF'); //專業人員
$pdf->Rect(242, 62.3, 3.8, 3.8, 3.5, 'DF'); //其他
$pdf->Rect(256, 62.3, 3.8, 3.8, 3.5, 'DF'); //教師
// $pdf->Rect(94, 55.6, 3.8, 3.8, 3.5, 'DF'); //研究人員
// $pdf->Rect(125, 55.6, 3.8, 3.8, 3.5, 'DF'); //專業人員
// $pdf->Rect(155.8, 55.6, 3.8, 3.8, 3.5, 'DF'); //其他
