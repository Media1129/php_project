...
$pdf->Rect(212.5, 125.3, 3.8, 3.8, 3.5, 'DF'); //退休年資採計
...
$pdf->Rect(205, 170.1, 3.8, 3.8, 3.5, 'DF'); //免受第37條及第38條限制之條件
...
if( $data['q03'] == '0' ){ //現職
  ...
  if( $data['q03_2']=='0'){
    ...
    $q03_2_other = ConvertToUTF8($data['q03_2other']);
  }
}
...
//q07 total year and total month
$q07_year_total = (int)$data["q07_be_year"]+(int)$data["q07_af_year"];
$q07_month_total = (int)$data["q07_be_month"]+(int)$data["q07_af_month"];
if($q07_month_total>=12){
  $q07_year_total+=1;
  $q07_month_total-=12;
}
...
if( $data['q09_5']=='Y'){
  ...
  $q09_other = ConvertToUTF8($data["q09_other"]);
}
//q10
if( $data['q10']=='Y'){
...
if( $data['q10_2']=='Y'){
  $pdf->Rect(212.5, 125.3, 3.8, 3.8, 'DF'); //退休年資採計
}
if( $data['q10_3']=='Y'){
...
if( $data['q11_99']=='Y'){
  ...
  $q11_other = ConvertToUTF8($data["q11_other"]);
}
//q12
if( $data['q12']=='Y'){
...
if( $data['q12_2']=='Y'){
  $pdf->Rect(205, 170.1, 3.8, 3.8, 'DF'); //免受第37條及第38條限制之條件
}
...
$tb1 = '
  ...
  <table border="1" cellpadding="2"  align="center" >
    <tr nobr="true">
      ...
      <th width="22%"><font style="text-align:left"> &emsp;&emsp;'.ConvertToUTF8($data["q_year"]).'年 &emsp;'.ConvertToUTF8($data["q_month"]).'月 &emsp;'.ConvertToUTF8($data["q_day"]).'日</font></th>
    </tr>
    ...
    <tr nobr="true">
      ...
      <th colspan="5"><font style="text-align:left" > &emsp;現職 &emsp;&emsp;&emsp;留停：1. &emsp;借調( &emsp;民營事業 &ensp;&emsp;財團法人 &emsp;行政法人 &ensp;政府機關(構) &ensp;&emsp;民間 &emsp;其他)<br> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 2. &emsp;育嬰；3. &emsp;侍親；4.
    ...
    <tr nobr="true">
      ...
      <th width="75%"><font style="text-align:left"> &emsp;提報退休案 &emsp;&emsp;制度瞭解或建議 &emsp;&emsp;退休規劃準備 &emsp;&emsp;退撫基金繳付 &emsp;&emsp;退休年資 &emsp;&emsp;其他 '.$q09_other.'</font></th>
    </tr>
    <tr nobr="true">
...
if($data['q13']=='0'){
  ...
  $q13_other = ConvertToUTF8($data["q13_other"]);
}
...
if($data['q16_99']=='Y'){
  ...
  $q16_other = ConvertToUTF8($data["q16_other"]);
}
//q17
if($data['q17']=='0'){
...
//----------------------------需要將名稱換成提供諮詢服務者-------------------------------------------------------------
//提供諮詢服務者
$provider_service_name = ConvertToUTF8($data["psn_name"]);
//------------------------------------------------------------------------------------------
...
$tb1 = '
  ...
  <table border="1" cellpadding="2"  align="center" >
    <tr nobr="true">
      <th width="7%"></th>
      <th width="13%"></th>
      <th width="75%"><font style="text-align:left"> &emsp;試算退休金 &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;其他 &emsp;'.$q12_other.'</font></th>
    </tr>
    <tr nobr="true">
      <th colspan="2"><font style="text-align:left">對教職員提供退休規畫建議</font></th>
      <th><font style="text-align:left"> &emsp;無（僅係提供法令規範之諮詢及解釋）<br> &emsp;有： &emsp;'.$q13_other.'</font></th>
    </tr>
    <tr nobr="true">
      <th colspan="2" rowspan="3"><br><br><font style="text-align:left">教職員提出的建議事項</font></th>
      <th><font style="text-align:left">退休制度規範面： &emsp;'.ConvertToUTF8($data["q14_1"]).'</font></th>
    </tr>
    <tr nobr="true">
      <th><font style="text-align:left">服務提供及管理： &emsp;'.ConvertToUTF8($data["q14_2"]).'</font></th>
    </tr>
    <tr nobr="true">
    ...
    <tr nobr="true">
      ...
      <th><font style="text-align:left"> &emsp;面對面 &emsp;&emsp;&emsp;&emsp;電話 &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;電子郵件 &emsp;&emsp;&emsp;&emsp;&emsp;其他 &emsp;'.$q16_other.'</font></th>
    </tr>
    <tr nobr="true">
...
$tbl = '
<font> &emsp;※備註：<br> &emsp;1.
本表應於提供服務後，
由提供諮詢服務者自行記錄
，不得由被服務者記錄填寫。
<br> &emsp;2.
提供諮詢服務前，應先向教職員說明所反應之意見將摘要記錄，並僅作為後續制度或實務改善之參考分析，絕不另作其他用途使用。
<br> &emsp;3.
本表僅諮詢服務對象係依「公立學校教職員退休資遣撫卹條例」辦理退休者適用之。
<br> &emsp;4.
為利後續統計分析用，請勿任意更改本表內容及順序。
<br><br> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;提供諮詢服務者： &emsp;'.$provider_service_name.'</font>
';
